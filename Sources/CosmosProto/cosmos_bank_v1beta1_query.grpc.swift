...
public protocol Cosmos_Bank_V1beta1_QueryClientInterceptorFactoryProtocol {
...
public protocol Cosmos_Bank_V1beta1_QueryProvider: CallHandlerProvider {
...
extension Cosmos_Bank_V1beta1_QueryProvider {
  public var serviceName: Substring { return "cosmos.bank.v1beta1.Query" }
...
public protocol Cosmos_Bank_V1beta1_QueryServerInterceptorFactoryProtocol {
