...
public protocol Cosmos_Upgrade_V1beta1_QueryClientInterceptorFactoryProtocol {
...
public protocol Cosmos_Upgrade_V1beta1_QueryProvider: CallHandlerProvider {
...
extension Cosmos_Upgrade_V1beta1_QueryProvider {
  public var serviceName: Substring { return "cosmos.upgrade.v1beta1.Query" }
...
public protocol Cosmos_Upgrade_V1beta1_QueryServerInterceptorFactoryProtocol {
