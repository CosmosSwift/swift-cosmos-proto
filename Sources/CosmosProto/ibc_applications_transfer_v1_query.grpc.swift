...
public protocol Ibc_Applications_Transfer_V1_QueryClientInterceptorFactoryProtocol {
...
extension Ibc_Applications_Transfer_V1_QueryProvider {
  public var serviceName: Substring { return "ibc.applications.transfer.v1.Query" }
