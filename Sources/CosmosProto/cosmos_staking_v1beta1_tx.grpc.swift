...
public protocol Cosmos_Staking_V1beta1_MsgClientInterceptorFactoryProtocol {
...
public protocol Cosmos_Staking_V1beta1_MsgProvider: CallHandlerProvider {
...
extension Cosmos_Staking_V1beta1_MsgProvider {
  public var serviceName: Substring { return "cosmos.staking.v1beta1.Msg" }
...
public protocol Cosmos_Staking_V1beta1_MsgServerInterceptorFactoryProtocol {
