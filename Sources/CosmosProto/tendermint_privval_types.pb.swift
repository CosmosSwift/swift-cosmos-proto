...
public struct Tendermint_Privval_AuthSigMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Tendermint_Privval_AuthSigMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Tendermint_Privval_AuthSigMessage, rhs: Tendermint_Privval_AuthSigMessage) -> Bool {
    if lhs._pubKey != rhs._pubKey {return false}
