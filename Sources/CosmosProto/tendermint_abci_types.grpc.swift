...
public protocol Tendermint_Abci_ABCIApplicationClientInterceptorFactoryProtocol {
...
public protocol Tendermint_Abci_ABCIApplicationProvider: CallHandlerProvider {
...
extension Tendermint_Abci_ABCIApplicationProvider {
  public var serviceName: Substring { return "tendermint.abci.ABCIApplication" }
...
public protocol Tendermint_Abci_ABCIApplicationServerInterceptorFactoryProtocol {
